...
public class FileEngine {
   ...
   private final String FilePath; 
    ...
    // Creates Entry to JSON file , with TimeToLive
    public void CreateEntry(String Key, JSONObject Value, int TimeToLive) throws 
    ...
    {    
         try {if (Key.length()>32) {
        	 ...
        	 throw new ValueSizeExceeded();
          	...
          	System.out.println(" Key size exceeds maximum size, Enter Valid 
...
Key");
    ...
    // Creates Entry to JSON file , without TimeToLive
...
Key");
    ...
    //Deletes/Removes JSONObject for Key
